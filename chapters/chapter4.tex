...
\[
\mathcal{Q}_k := \int_\X \Phi_\X (x') \otimes \Phi_\X(x') d \rho_f (x',x). 
\]
...
\begin{obs}
    En lo que sigue se supondrá que se cumple \ref{eq:condi_g}. Un ejemplo de esto es cuando $\mathbf{g}$ es aditiva y el ruido tiene matriz de covarianza definida positiva, esto es, si
    \[
...
\]
con $c_1$ la constante de inyectividad de $C_X$. Si $\U \H_X \subset \H_X$, $\G \R^p \subset \H_X$, entonces con probabilidad al menos $(1 - \delta)^4$ se tiene que existen constantes $C_i^j$, dependientes de $\delta$, para $i \in \{1, 2, 3\}$, $j \in \{1, 2\}$ tales que
	\begin{equation*}
		\begin{aligned}
...
\begin{proof}
	...
	\begin{equation*}
		...
		\end{aligned}
	\end{equation*}
	Por teorema \ref{teo:error_koop_sqrt_N_def} entonces se concluye que con probabilidad $(1-\delta)^4$ existen constantes $C^1_{1, k}$ y $C^2_{1, k}$ tales que
	\begin{equation*}
		\begin{aligned}
...
\delta > 2 \text{exp} \left ( -\frac{Nc_1^2}{8\|k\|_\infty}\right )
\]
con $c_1$ la constante de inyectividad de $C_X$. Si $\U \H_X \subset \H_X$, $\G \R^p \subset \H_X$, entonces con probabilidad al menos $(1 - \delta)^4$ se tiene que existen constantes $\Tilde{C}^1_k$, $\Tilde{C}^2_k$ tales que
    \begin{equation*}
...
\begin{proof}
    ...
    \begin{equation*}
        ...
        \end{aligned}
    \end{equation*}
    Entonces, por teoremas \ref{teo:error_koop_sqrt_N_def} y \ref{teo:teo_kerKKF_2} se tiene que con probabilidad $(1-\delta)^4$ existe constantes $C$, $C_k^1$ tales que 
    \begin{equation*}
         \| \hat{\mathbf{x}}_k - \hat{\mathbf{x}}_{N, k} \| \leq \| \B \| C_k^1 N^{-1/2} + \| \hat{\mu}_{N, k} \| C N^{-1/2} = \Tilde{C}_{k}^1 N^{-1/2}
    \end{equation*}
    donde se ha utilizado $\| \B^* \| \leq \| \B \|$, $\| \B^* - \B^*_N \| \leq \| \B - \B_N \|$ y denotado $\Tilde{C}_{k}^1 = \| \B \| C_k^1 + \| \hat{\mu}_{N, k} \| C N^{-1/2}$. Ahora para la matriz de covarianza de error a posteriori
    \begin{equation*}
        \begin{aligned}
        ...
        \end{aligned}
    \end{equation*}
    Usando nuevamente los teoremas \ref{teo:error_koop_sqrt_N_def} y \ref{teo:teo_kerKKF_2} se tiene que probabilidad $(1-\delta)^4$ existen constantes $C$, $C_k^2$ tales que 
    \begin{equation*}
...
\delta > 2 \text{exp} \left ( -\frac{Nc_1^2}{8\|k\|_\infty}\right )
\]
con $c_1$ la constante de inyectividad de $C_X$. Si $\U \H_X \subset \H_X$, $\G \R^p \subset \H_X$, entonces con probabilidad al menos $(1 - \delta)^4$ se tiene que existen constantes $\hat{C}_1$ y $\hat{C}_2$ tales que
    \begin{enumerate}
    ...
    \end{equation*}
        \item El estimador $\hat{\mathbf{x}}_{N, k}$ es un $\Tilde{C}_2 N^{-1/2}$-mínimo del problema de filtraje, esto es
    \begin{equation*}
...
\begin{proof}
    ...
    \begin{equation*}
        ...
        \end{aligned}
    \end{equation*}
    donde se han utilizado nuevamente los teoremas \ref{teo:error_koop_sqrt_N_def} y \ref{teo:teo_kerKKF_2} para decir que dicha constante $\hat{C}_1$ existe con probabilidad a lo menos $(1-\delta)^4$. Para probar el punto 2. notar que
    \begin{equation*}
    ...
    \begin{equation*}
        ...
        \end{aligned}
    \end{equation*}
    donde se han utilizado nuevamente los teoremas \ref{teo:error_koop_sqrt_N_def} y \ref{teo:teo_kerKKF_2} para decir que dicha constante $\hat{C}_2$ existe con probabilidad a lo menos $(1-\delta)^4$. Con ello
    \begin{equation*}
...
\begin{table}[h!]
    ...
    \textbf{SIR} & 60.9 & 222.5 & 34.3 \\ \hline
    \textbf{SIRS} & 141.4 & 315.3 & 30.7 \\ \hline
    \textbf{SEIR} & 209.9 & 755.4 & 33.9 \\ \hline
    \end{tabular}
    \label{tab:ex_times}
\end{table}