...
\]
con $c_1$ la constante de inyectividad de $C_X$. Si $\U \H_X \subset \H_X$, $\G \R^p \subset \H_X$, entonces con probabilidad al menos $(1 - \delta)^4$ se tiene que existen constantes $C_k^1$ y $C_k^2$, dependientes de $\delta$, tales que
	\begin{equation*}
		\begin{aligned}
	...
	\begin{equation*}
		...
		\end{aligned}
	\end{equation*}
	En donde las constantes $C_k^j$ son positivas y dependen de $k$ solo a través de $\| \U \| $, $\| \G \| $, $\| \mathcal{Q}_{j} \| $, $\| \mathcal{R}_{j} \| $, $\| \S_{k}^{-1} \| $, $\| \hat{\mu}_{j} \| $ y $\| \mathcal{P}_{j} \| $, con $j \in \{ 0, \dots, k-1\}$.
...
\begin{proof}
	...
	\begin{equation*}
		...
		\end{aligned}
	\end{equation*}
	Por teorema \ref{teo:error_koop_sqrt_N_def} entonces se concluye que con probabilidad $(1-\delta)^4$ existen constantes $C^1_{1, k}$ y $C^2_{1, k}$, dependientes de $\delta$, tales que
	\begin{equation*}
		\begin{aligned}
