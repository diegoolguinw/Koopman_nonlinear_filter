...
\begin{defn}[Operadores de embedding condicional]   
...
\end{equation*}
Estos operadores están representados mediante las matrices \( \Phi_N (X) \), \( \Phi_N (X^+) \), \( Y \) y \( X \), respectivamente. A continuación, se definen los operadores:
\begin{equation*}
